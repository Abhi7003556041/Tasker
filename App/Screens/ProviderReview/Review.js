...
const Review = props => {
     ...
     const receiverTypeData = props.route.params.requesterID;
     ...
     const sendButton = () => {
          let data = {
               receiverID: profileData.providerID,
               taskID: providerTypeData,
               review: reviewType,
               rating: rating,
          };
          // console.log("senddd>>>>>>>>", data)
          HomeService.reviewData(data).then(res => {
               console.log("Review is given to provider>>>>>>",JSON.stringify(res));
               if (res) {
               ...
               <KeyboardAwareScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <ImageBackground
                         ...
                         <Text
                              ...
                              {profileData.providerData?.firstName} {profileData.providerData?.lastName}
                              {/* sdsds */}
                         </Text>
